...
Use the same `canonicalKey` for every locale variant of one document. It is
required on every provider document and must remain stable when route mounts
or translated slugs change.
