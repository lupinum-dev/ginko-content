...
those files. `delivery: 'runtime'` keeps public content pages out of a server
build's prerender crawl and lets Nitro negotiate them. A true static generation
still creates complete HTML and agent files.
