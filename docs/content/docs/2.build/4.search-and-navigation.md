...
description: Add MiniSearch and an ordered navigation menu to a routed content site.
navigation:
...
Search for a heading and follow several nested navigation links before deploying.
