---
title: Build a blog
description: A typed post collection, a post page with previous and next links, and a paginated index.
---

A blog is one page collection for the post routes plus a normal Nuxt page for the index. Start with the collection.
...
**Next:** [Drafts and partials](/docs/guides/drafts-and-partials) · [Query API](/docs/reference/query-api)
