...
description: A copy-paste recipe for a docs collection at /docs with an ordered sidebar and previous/next links.
---

A docs site needs three things: a collection mounted at `/docs`, a page that renders any route under it, and a sidebar. Start with the collection.
...
To add search over these docs, see [search and navigation](/docs/build/search-and-navigation). To emit a sitemap for the same routes, see [sitemap and prerender](/docs/guides/sitemap-and-prerender).

**Next:** [Search and navigation](/docs/build/search-and-navigation) · [Navigation guide](/docs/guides/navigation) · [Sitemap and prerender](/docs/guides/sitemap-and-prerender)
