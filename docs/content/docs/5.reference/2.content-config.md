...
General files such as PDFs are not managed or portable yet. Ginko Content does
not expose a generic file field until that lifecycle is supported end to end;
use a canonical external HTTPS reference when the content model needs one.
