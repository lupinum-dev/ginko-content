...
provider routing. Runtime delivery keeps public content pages out of a server
build's prerender crawl. A pure static generation still produces complete HTML
and agent files because it cannot run request-time middleware.
