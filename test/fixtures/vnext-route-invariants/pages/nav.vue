...
// VNEXT 20.1: proves the `content:file:beforeParse` hook's effect on the
...
<template>
  ...
  <!-- VNEXT 14.4/20.1: proves the real `content.transformers` wiring's
  ...
  <!-- VNEXT 15.1/20.1: the cross-artifact golden's fact source -- query,
