...
- **T3.1c — Stub.** `MissingDocument` + shared `isRealDocument` guard (replace the local copy in `runtime/server/api/cache.ts`). (The reserved-key guard moved into T3.1a per the 2026-07-08 second ruling.)
