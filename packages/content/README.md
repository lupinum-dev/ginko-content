...
> [!WARNING]
> Version `1.0.0-beta.1` is a prerelease. Install it from npm's `next`
...
```bash
npx nuxi module add @lupinum/ginko-content@1.0.0-beta.1
```

Or install and register the module by hand:

```bash
pnpm add @lupinum/ginko-content@1.0.0-beta.1
```
