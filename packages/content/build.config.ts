...
const mkdistEntries = [
  ...
  // Node-only reader for the canonical contract artifact generated by the
  // Nuxt module. Keep filesystem code out of the pure CMS contract subpath.
  ['src/cms-contract-node/', 'dist/cms-contract-node'],
